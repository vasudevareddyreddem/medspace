   	...
   	<?php if(isset($waste_list) && count($waste_list)>0){ ?>
		<table cellpadding="0" cellspacing="0" style="border:1px solid #aaa;border-bottom:0px solid #fff;">
			...
			<tr >
                ...
                <th colspan="13" rowspan="1" style="font-size:14px;">Details of Bio medical Generated by the HCF (Qty. of BMW in Kg)</th>
            </tr> 
			<tr>
				...
				<td colspan="2" class="bg-yellow text-center">Yellow (C)</td>
