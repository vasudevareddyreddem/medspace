...
<div  style="width:105mm;height:100%;text-align:center;">
	...
	<div style="display:flex;justify-content: center;">
	   <div class="sticker" style="width:50mm;height:50mm;background:#fff;overflow:hidden;position:relative;margin:3mm 0mm 0mm 0mm;border-radius:5px;border:0.5px solid #ddd;">
		  <div style="">
			 <div >
			 ...
			 <div class="">
				...
				<div style="position:absolute;top:3mm;left:3mm;line-height: 25px;" class="<?php echo $list[0]['category'] ; ?>-col"><?php if($list[0]['type']=='Yellow(C)'){ echo "C";} ?></div>
			 </div>
			 <div >
	   ...
	   <div class="sticker" style="width:50mm;height:50mm;background:#fff;overflow:hidden;position:relative;margin:3mm 0mm 0mm 0mm;border-radius:5px;border:0.5px solid #ddd;">
		  <div style="">
			 ...
			 <div class="">
				...
				<div style="position:absolute;top:3mm;left:3mm;line-height: 25px;" class="<?php echo $list[1]['category'] ; ?>-col"><?php if($list[1]['type']=='Yellow(C)'){ echo "C";} ?></div>
			 </div>
			 <div >
