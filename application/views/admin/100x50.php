...
<div style="display:flex;justify-content: center;">
   <div class="sticker" style="width:50mm;height:50mm;background:#fff;overflow:hidden;position:relative;margin:3mm 0mm 0mm 0mm;border-radius:5px">
      <div style="">
         <div >
            <div style="padding:0px;margin-left:8mm;margin-top:1mm;font-size:16px;height:10mm">Seq.No.0042003 </span></div>
         </div>
         <div class="">
            <div>
               <img style="width:auto;height:30mm;padding:2px 0px;" src="http://localhost/medspace/assets/hospital_waste_barcodes/0.69104200 1569595068.png" alt="gr" >
            </div>
            <div style="position:absolute;top:1mm;left:1mm" class="yellow-col"></div>
         </div>
         <div >
            <div style="padding:0px;margin:0px;font-size:15px">RAMMA110001DLBH02497</span></div>
         </div>
      </div>
   </div>
   <div class="sticker" style="width:50mm;height:50mm;background:#fff;overflow:hidden;position:relative;margin:3mm 0mm 0mm 0mm;border-radius:5px">
