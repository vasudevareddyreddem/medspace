                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						...
						<div class="col-md-4  col-md-offset-2">
							...
							<input type="text" class="form-control" placeholder="Enter Hospital Id">
						</div>
						...
						<div class="popover fade right in" role="tooltip" id="popover436935" style="top: 0;  display: block;">
							...
							<div class="popover-content">Enter your Hospital ID to get Details</div>
						</div>
						</div>
						</div>
						</div>
                    ...
                    <form id="defaultForm" method="post" class="form-horizontal" action="target.php">
						...
						<div class="form-group">
                            ...
                            <div class="">
                                <input type="text" class="form-control" name="username" Placeholder=" Enter Disposal Qty" />
                            </div>
                        </div>
                        </div>
						<div class="col-md-6 px-25px">
						<div class="form-group">
                            ...
                            <div class="">
                                <input type="text" class="form-control" name="username" placeholder=" Enter Remaining Qty" />
                            </div>
                        </div>
                        </div>
						<br>
