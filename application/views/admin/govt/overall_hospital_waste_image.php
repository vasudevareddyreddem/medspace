                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
									...
									<?php foreach($waste_imgs as $list){ ?>
                                        ...
                                        <tr>
										 ...
										 <td data-toggle="modal" data-target="#myModal"><img height="50px;" width="50px;" src="<?php echo base_url('assets/hospital-waste-images/'.$list['image']); ?>"></td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">HCF Waste Image</h4>
        </div>
