   ...
   <div class="row clearfix">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
         <div class="card">
            ...
            <div class="body">
			<form action="<?php echo base_url('plant/details_list'); ?>"  method="post">
                  <div class="">
                     <div class="row">
                        <div class="col-md-4">
                           <label>From</label>
			  	...
			  	<form target="_blnak" onsubmit="return get_waste_pdf()" action="<?php echo base_url('plant/waste_pdf'); ?>" method="post">
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('plant/plant_ajax_list')?>",
            "type": "POST",
			"data": {
