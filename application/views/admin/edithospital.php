                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form id="defaultForm" method="post" class="form-horizontal" action="<?php echo base_url('hospital/editpost'); ?>">
						...
						<div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input type="text" class="form-control" name="hospital_id" id="hospital_id" placeholder="Enter Hospital ID" value="<?php echo isset($hospital_detail['hospital_id'])?$hospital_detail['hospital_id']:'';?>" />
                            </div>
                        </div>
						<div class="form-group">
						...
						<div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <textarea class="form-control" rows="5" id="address" name="address"><?php echo isset($hospital_detail['address'])?$hospital_detail['address']:'';?></textarea>
                            </div>
                        </div>
						<div class="form-group">
