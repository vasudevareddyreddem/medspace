...
class Hospital_wisegraph_model extends CI_Model {
	...
	private function _get_datatables_query($hid)
	{
	...
	function get_datatables($hid)
	{
		$this->_get_datatables_query($hid);
		if($_POST['length'] != -1)
